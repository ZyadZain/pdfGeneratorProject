...
<style>
    /* ================================================================
       VERSION BROWSERSHOT / CHROMIUM — mécanisme natif
       En-tête/pied : PAS de position:fixed. Chrome utilise sa fonction
       d'impression native, alimentée par headerHtml()/footerHtml()
       côté PHP (voir le controller), avec ses classes spéciales
       .pageNumber et .totalPages pour la pagination.
       ================================================================ */
...
<body>
    ...
    <p>
        L'en-tête bleu et le pied de page sont fournis à Chrome via sa
        fonction d'impression native et doivent apparaître à l'identique
        sur les 4 pages, avec la pagination « Page X / Y ».
    </p>
